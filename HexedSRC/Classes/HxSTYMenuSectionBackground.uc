...
defaultproperties
{
    KeyName="HxMenuSectionBackground"
    ...
    ImgColors(0)=(R=0,G=38,B=74,A=176)
    ImgColors(1)=(R=0,G=38,B=74,A=176)
    ImgColors(2)=(R=0,G=38,B=74,A=176)
    ImgColors(3)=(R=0,G=38,B=74,A=176)
    ImgColors(4)=(R=0,G=38,B=74,A=176)
