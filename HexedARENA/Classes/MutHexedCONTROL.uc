...
defaultproperties
{
    FriendlyName="HexedCONTROL v9rc3"
    ...
    Properties(3)=(Name="BonusAdrenaline",Type=HX_PROPERTY_Int,LowerLimit="0",UpperLimit="100")
    Properties(4)=(Name="BonusAdrenalineOnSpawn",Type=HX_PROPERTY_Int,LowerLimit="-100",UpperLimit="100")
    Properties(5)=(Name="SelfDamageScale",Type=HX_PROPERTY_Float,LowerLimit="0.0",UpperLimit="1.0")
    Properties(6)=(Name="HealthLeechRatio",Type=HX_PROPERTY_Float,LowerLimit="0.0",UpperLimit="5.0")
    Properties(7)=(Name="HealthLeechLimit",Type=HX_PROPERTY_Int,LowerLimit="0",UpperLimit="199")
    Properties(8)=(Name="bNoSpeedCombo",Type=HX_PROPERTY_Bool)
    Properties(9)=(Name="bNoBerserkCombo",Type=HX_PROPERTY_Bool)
    Properties(10)=(Name="bNoBoosterCombo",Type=HX_PROPERTY_Bool)
    Properties(11)=(Name="bNoInvisibleCombo",Type=HX_PROPERTY_Bool)
    Properties(12)=(Name="bNoAdrenalinePills",Type=HX_PROPERTY_Bool)
    Properties(13)=(Name="bNoHealthVials",Type=HX_PROPERTY_Bool)
    Properties(14)=(Name="bNoHealthPacks",Type=HX_PROPERTY_Bool)
    Properties(15)=(Name="bNoSuperHealthPacks",Type=HX_PROPERTY_Bool)
    Properties(16)=(Name="bNoShieldPacks",Type=HX_PROPERTY_Bool)
    Properties(17)=(Name="bNoSuperShieldPacks",Type=HX_PROPERTY_Bool)
    Properties(18)=(Name="bNoUDamagePacks",Type=HX_PROPERTY_Bool)
    Properties(19)=(Name="bNoAmmoPacks",Type=HX_PROPERTY_Bool)
    Properties(20)=(Name="MaxSpeedMultiplier",Type=HX_PROPERTY_Float,LowerLimit="-100.0",UpperLimit="100.0")
    Properties(21)=(Name="AirControlMultiplier",Type=HX_PROPERTY_Float,LowerLimit="-10.0",UpperLimit="10.0")
    Properties(22)=(Name="BaseJumpMultiplier",Type=HX_PROPERTY_Float,LowerLimit="-10.0",UpperLimit="10.0")
    Properties(23)=(Name="MultiJumpMultiplier",Type=HX_PROPERTY_Float,LowerLimit="-100.0",UpperLimit="100.0")
    Properties(24)=(Name="BonusMultiJumps",Type=HX_PROPERTY_Int,LowerLimit="-1",UpperLimit="99")
    Properties(25)=(Name="DodgeMultiplier",Type=HX_PROPERTY_Float,LowerLimit="-10.0",UpperLimit="10.0")
    Properties(26)=(Name="DodgeSpeedMultiplier",Type=HX_PROPERTY_Float,LowerLimit="-10.0",UpperLimit="10.0")
    Properties(27)=(Name="bNoWallDodge",Type=HX_PROPERTY_Bool)
    Properties(28)=(Name="bNoDodgeJump",Type=HX_PROPERTY_Bool)
    DisplayInfo(0)=(Section="Starting Values",Caption="Bonus health",Hint="Bonus to starting health (between -99 and 99). Applied on spawn.")
    DisplayInfo(1)=(Section="Starting Values",Caption="Bonus shield",Hint="Bonus to starting shield (between 0 and 150). Applied on spawn.")
    DisplayInfo(2)=(Section="Starting Values",Caption="Bonus AR grenades",Hint="Bonus to starting number of AR grenades (between -4 and 99). Applied on spawn.")
    DisplayInfo(3)=(Section="Starting Values",Caption="Bonus adrenaline",Hint="Bonus to starting adrenaline (between 0 and 100). Applied on restart/map change.")
    DisplayInfo(4)=(Section="Starting Values",Caption="Bonus adrenaline on spawn",Hint="Bonus to adrenaline on spawn (between -100 and 100). Applied on spawn.")
    DisplayInfo(5)=(Section="Damage",Caption="Self-damage scale",Hint="How much damage you do to yourself. Applied instantly.")
    DisplayInfo(6)=(Section="Health Leech",Caption="Health leech ratio",Hint="Ratio to leech health from damage dealt (between 0.0 and 5.0).")
    DisplayInfo(7)=(Section="Health Leech",Caption="Health leech limit",Hint="Limit up to how much health can be filled with leech (between 0 and 199).")
    DisplayInfo(8)=(Section="Power-Ups",Caption="No speed combo",Hint="Disable speed combo (up, up, up, up). Applied instantly.")
    DisplayInfo(9)=(Section="Power-Ups",Caption="No berserk combo",Hint="Disable berserk combo (up, up, down, down). Applied instantly.")
    DisplayInfo(10)=(Section="Power-Ups",Caption="No booster combo",Hint="Disable booster combo (down, down, down, down). Applied instantly.")
    DisplayInfo(11)=(Section="Power-Ups",Caption="No invisible combo",Hint="Disable invisible combo (right, right, left, left). Applied instantly.")
    DisplayInfo(12)=(Section="Pick-Ups",Caption="No adrenaline pills",Hint="Disable adrenaline pills. Applied instantly.")
    DisplayInfo(13)=(Section="Pick-Ups",Caption="No health vials",Hint="Disable health vials. Applied instantly.")
    DisplayInfo(14)=(Section="Pick-Ups",Caption="No health packs",Hint="Disable health packs. Applied instantly.")
    DisplayInfo(15)=(Section="Pick-Ups",Caption="No super health packs",Hint="Disable super health packs. Applied instantly.")
    DisplayInfo(16)=(Section="Pick-Ups",Caption="No shield packs",Hint="Disable shield packs. Applied instantly.")
    DisplayInfo(17)=(Section="Pick-Ups",Caption="No super shield packs",Hint="Disable super shield packs. Applied instantly.")
    DisplayInfo(18)=(Section="Pick-Ups",Caption="No UDamage packs",Hint="Disable UDamage packs. Applied instantly.")
    DisplayInfo(19)=(Section="Pick-Ups",Caption="No ammo packs",Hint="Disable ammo packs. Applied instantly.")
    DisplayInfo(20)=(Section="Movement",Caption="Speed multiplier",Hint="Coefficient to multiply maximum movement speed (between -100.0 and 100.0). Applied on spawn.")
    DisplayInfo(21)=(Section="Movement",Caption="Air control multiplier",Hint="Coefficient to multiply air control (between -10.0 and 10.0). Applied on spawn.")
    DisplayInfo(22)=(Section="Movement",Caption="Base jump multiplier",Hint="Coefficient to multiply base jump acceleration (between -10.0 and 10.0). Applied on spawn.")
    DisplayInfo(23)=(Section="Movement",Caption="Multi-jump multiplier",Hint="Coefficient to multiply multi-jump acceleration boost (between -100.0 and 100.0). Applied on spawn.")
    DisplayInfo(24)=(Section="Movement",Caption="Bonus multi-jumps",Hint="Bonus to add to base amount of multi-jumps (between -1 and 99). Applied on spawn.")
    DisplayInfo(25)=(Section="Movement",Caption="Dodge multiplier",Hint="Coefficient to multiply dodge acceleration (Z-axis, between -10.0 and 10.0). Applied on spawn.")
